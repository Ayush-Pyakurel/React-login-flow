...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //this is to re-confirm the username and password are valid before submitting form
    const userValidation = USER_REGEX.test(user);
    const passwordValidation = PWD_REGEX.test(password);
    if (!userValidation || !passwordValidation) {
      setErrorsMsg("Invalid Entry");
      return;
    }
    setSuccess(true);
      ...
      {success ? (
        ...
        <section>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              disabled={!validName || !validMatchPassword || !validPassword}
            >
              Sign Up
            </button>
